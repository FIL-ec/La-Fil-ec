...
(function() {
    ...
    const MobileNavigation = {
        ...
        createMobileToggle: function() {
            ...
            // Añadir estilos CSS dinámicamente para mobile toggle
        ...
        showPurchaseModal: function(name, price) {
            ...
            modal.innerHTML = `
                ...
                <div class="modal-content">
                    ...
                    <p>Para completar tu compra, contáctanos a través de:</p>
                    <div class="contact-options">
                        <a href="mailto:info@lafil.com" class="contact-btn">📧 Email</a>
                        <a href="tel:+15551234567" class="contact-btn">📱 Teléfono</a>
                        <a href="https://instagram.com" class="contact-btn" target="_blank">📸 Instagram</a>
                    </div>
    ...
    // Validación de formularios (para futuros formularios)
    const FormValidator = {
    ...
    function initializeApp() {
        ...
        try {
            ...
            setTimeout(() => {
                NotificationSystem.show('¡Bienvenido a La Fil! Explora nuestros productos.', 'success', 4000);
            }, 1500);
    ...
    // Event listeners para la inicialización y limpieza
    ...
    // Exponer algunas funciones globalmente para debugging (solo en desarrollo)
    ...
    // Prevenir errores de consola por recursos faltantes
